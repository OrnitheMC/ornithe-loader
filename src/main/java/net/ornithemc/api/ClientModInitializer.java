 ...
 *
 * <p>In {@code ornithe.mod.json}, the entrypoint is defined with {@code client} key.</p>
 *
 * @see ModInitializer
 * @see DedicatedServerModInitializer
 * @see net.ornithemc.loader.api.OrnitheLoader#getEntrypointContainers(String, Class)
 */
@FunctionalInterface
