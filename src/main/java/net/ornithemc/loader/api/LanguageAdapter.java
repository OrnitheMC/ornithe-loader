 ...
 *
 * <p>A language adapter is defined as so in {@code ornithe.mod.json}:
 * <pre><blockquote>
 *   "languageAdapter": {
 ...
 *
 * <p>The {@code default} language adapter from Ornithe Loader can accept {@code value} as follows:
 * <ul>
 ...
 *     }
 *   </blockquote></pre>
 *   You would declare {@code "net.ornithemc.example.ExampleMod"}.</p>
 *
 ...
 *     }
 *   </blockquote></pre>
 *   You would declare {@code "net.ornithemc.example.ExampleMod::INSTANCE"}.</p>
 *   </li>
 *
 *   <li>A fully qualified reference to a class in binary name followed by {@code ::} and a
 ...
 *     }
 *   </blockquote></pre>
 *   You would declare {@code "net.ornithemc.example.ExampleMod::init"}.</p>
 *   </li>
 * </ul>
 */
