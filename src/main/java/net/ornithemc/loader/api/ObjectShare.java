...
/**
 * Object share for inter-mod communication, obtainable through {@link OrnitheLoader#getObjectShare}.
 *
...
public interface ObjectShare {
	 ...
	 * <pre>
	 * if (OrnitheLoader.getInstance().getObjectShare().get("someMod:someValue") instanceof String value) {
	 *   // use value here
	 * }
	 * </pre>
	 *
	 ...
	 * <pre>
	 * if (OrnitheLoader.getInstance().getObjectShare().get("mymod:fuel") instanceof Consumer{@code<?>} c) {
	 ...
	 * <p>Example use:
	 * <pre>
	 * OrnitheLoader.getInstance().getObjectShare().whenAvailable("someMod:someValue", (k, v) -> {
