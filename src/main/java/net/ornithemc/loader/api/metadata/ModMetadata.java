...
package net.ornithemc.loader.api.metadata;
...
public interface ModMetadata {
	 ...
	 *
	 * <p>The types may be {@code ornithe} or {@code builtin} by default.</p>
	 *
	...
	/**
	 * Returns if the mod's {@code ornithe.mod.json} declares a custom value under {@code key}.
	 *
	 * @param key the key
	...
	/**
	 * Returns the mod's {@code ornithe.mod.json} declared custom value under {@code key}.
	 *
	 * @param key the key
