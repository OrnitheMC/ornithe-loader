...
package net.ornithemc.loader.impl.entrypoint;
...
import net.ornithemc.loader.api.EntrypointException;
...
public final class EntrypointStorage {
	...
	private static class OldEntry implements Entry {
		...
		public synchronized <T> T getOrCreate(Class<T> type) throws Exception {
			if (object == null) {
				net.fabricmc.loader.language.LanguageAdapter adapter = (net.fabricmc.loader.language.LanguageAdapter) Class.forName(languageAdapter, true, OrnitheLauncherBase.getLauncher().getTargetClassLoader()).getConstructor().newInstance();
