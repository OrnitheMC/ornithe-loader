...
public final class LoaderUtil {
	...
	public static void verifyNotInTargetCl(Class<?> cls) {
		if (cls.getClassLoader().getClass().getName().equals("net.ornithemc.loader.impl.launch.knot.KnotClassLoader")) {
			// This usually happens when ornithe loader has been added to the target class loader. This is a bad state.
