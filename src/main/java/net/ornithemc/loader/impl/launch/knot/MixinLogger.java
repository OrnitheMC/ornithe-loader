...
import net.ornithemc.loader.impl.util.log.LogLevel;
...
final class MixinLogger extends LoggerAdapterAbstract {
	...
	public void log(Level level, String message, Object... params) {
		LogLevel ornitheLevel = translateLevel(level);
		if (!Log.shouldLog(ornitheLevel, logCategory)) return;
		...
		Log.log(ornitheLevel, logCategory, message, exc);
	}
