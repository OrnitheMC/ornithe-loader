...
public class MixinServiceKnot implements IMixinService, IClassProvider, IClassBytecodeProvider, ITransformerProvider, IClassTracker {
	...
	public byte[] getClassBytes(String name, String transformedName) throws IOException {
		return OrnitheLauncherBase.getLauncher().getClassByteArray(name, true);
	}

	public byte[] getClassBytes(String name, boolean runTransformers) throws ClassNotFoundException, IOException {
		byte[] classBytes = OrnitheLauncherBase.getLauncher().getClassByteArray(name, runTransformers);
	...
	public Class<?> findClass(String name) throws ClassNotFoundException {
		return OrnitheLauncherBase.getLauncher().getTargetClassLoader().loadClass(name);
	}

	@Override
	public Class<?> findClass(String name, boolean initialize) throws ClassNotFoundException {
		return Class.forName(name, initialize, OrnitheLauncherBase.getLauncher().getTargetClassLoader());
	}
	...
	public String getName() {
		return OrnitheLauncherBase.getLauncher() instanceof Knot ? "Knot/Ornithe" : "Launchwrapper/Ornithe";
	}
	...
	public InputStream getResourceAsStream(String name) {
		return OrnitheLauncherBase.getLauncher().getResourceAsStream(name);
	}
	...
	public boolean isClassLoaded(String className) {
		return OrnitheLauncherBase.getLauncher().isClassLoaded(className);
	}
	...
	public String getSideName() {
		return OrnitheLauncherBase.getLauncher().getEnvironmentType().name();
	}
