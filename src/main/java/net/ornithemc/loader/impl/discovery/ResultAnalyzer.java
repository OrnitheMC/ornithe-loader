...
import net.ornithemc.loader.impl.discovery.ModSolver.AddModVar;
import net.ornithemc.loader.impl.discovery.ModSolver.InactiveReason;
import net.ornithemc.loader.impl.metadata.AbstractModMetadata;
import net.ornithemc.loader.impl.util.Localization;
import net.ornithemc.loader.impl.util.StringUtil;
import net.ornithemc.loader.impl.util.version.VersionIntervalImpl;
...
final class ResultAnalyzer {
	...
	private static String getName(ModCandidate candidate) {
		...
		case AbstractModMetadata.TYPE_ORNITHE_MOD:
