...
public interface GameProvider { // name directly referenced in net.ornithemc.loader.impl.launch.knot.Knot.findEmbedddedGameProvider() and service loader records
	String getGameId();
	String getGameName();
	...
	boolean isEnabled();
	boolean locateGame(OrnitheLauncher launcher, String[] args);
	void initialize(OrnitheLauncher launcher);
	GameTransformer getEntrypointTransformer();
	void unlockClassPath(OrnitheLauncher launcher);
