...
public class ModClassLoader_125_FML extends URLClassLoader {
	...
	public ModClassLoader_125_FML() {
		super(new URL[0], OrnitheLauncherBase.getLauncher().getTargetClassLoader());
		localUrls = new URL[0];
	}

	@Override
	protected void addURL(URL url) {
		OrnitheLauncherBase.getLauncher().addToClassPath(UrlUtil.asPath(url));
	...
	public File getParentSource() {
		return ((MinecraftGameProvider) OrnitheLoaderImpl.INSTANCE.getGameProvider()).getGameJar().toFile();
	}
