...
package net.ornithemc.loader.impl.game.minecraft.applet;
 ...
 *
 * <p>It has been adapted here for the purposes of the Ornithe loader.
 */
...
public class AppletFrame extends Frame implements WindowListener {
	...
	public void launch(String[] args) {
		...
		for (String key : arguments.keys()) {
			applet.getParams().put("ornithe.arguments." + key, arguments.get(key));
		}
