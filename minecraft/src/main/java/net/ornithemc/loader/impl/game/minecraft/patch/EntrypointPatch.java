...
package net.ornithemc.loader.impl.game.minecraft.patch;
...
import net.ornithemc.loader.impl.game.minecraft.Hooks;
import net.ornithemc.loader.impl.game.patch.GamePatch;
...
public class EntrypointPatch extends GamePatch {
	...
	@Override
	public void process(OrnitheLauncher launcher, Function<String, ClassReader> classSource, Consumer<ClassNode> classEmitter) {
		...
		if (type == EnvType.SERVER) {
			...
			if (runDirectory == null) {
				...
				it.add(new InsnNode(Opcodes.ACONST_NULL));
				it.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "net/ornithemc/loader/impl/game/minecraft/applet/AppletMain", "hookGameDir", "(Ljava/io/File;)Ljava/io/File;", false));
				it.add(new VarInsnNode(Opcodes.ALOAD, 0));
				finishEntrypoint(type, it);
			} else {
				// Indev and above.
